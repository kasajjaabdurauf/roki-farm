-- =====================================================================
-- ROKI — FULL FRESH START (ONE SHOT) — idempotent
-- Wipes everything → re-creates schema → applies migrations v2→v11 →
-- allows harvest-log inserts for the field demo.
-- =====================================================================
...
-- ══════════ 3 · MIGRATIONS v2→v11 ══════════
-- =====================================================================
-- Roki — COMBINED MIGRATION (v2 → v11) — run ONCE after schema.sql
...
-- ══════════ DONE — sign up fresh; first account = Admin ══════════
