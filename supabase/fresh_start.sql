-- =====================================================================
-- ROKI — FULL FRESH START (ONE SHOT)
-- Wipes everything → re-creates schema → applies all migrations →
-- allows harvest-log inserts for the field demo.
-- Run ONCE in the Supabase SQL Editor. Everything after this works.
-- =====================================================================
